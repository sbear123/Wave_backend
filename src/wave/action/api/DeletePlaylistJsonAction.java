...
import bean.DeletePlaylistDBBean;
...
public class DeletePlaylistJsonAction implements Action{
	...
	public String requestProcess(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		System.out.println(list.getlistId()+ "  " + list.getUserId());
		int count = DeletePlaylistDBBean.getInstance().DeleteList(list.getUserId(), list.getlistId());
